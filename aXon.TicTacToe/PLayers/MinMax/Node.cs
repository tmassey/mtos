...
namespace aXon.TicTacToe.Players
{
	class Node
	{
		...
		private  Node[] _children = new Node[Board.SIZE * Board.SIZE];
	 ...
	 */
		public bool isLeaf ()
		{
			if (this._leafdef == false) {
				...
				|| Board.isWinner (this._board, aXon.TicTacToe.Game.TicTacToe.NOUGHTS) || Board
					.isWinner (this._board, aXon.TicTacToe.Game.TicTacToe.CROSSES));
			}
			return this._leaf;
		}
	 ...
	 */
		public int player ()
		{
			return (this._move == null ? aXon.TicTacToe.Game.TicTacToe.NOUGHTS : aXon.TicTacToe.Game.TicTacToe.reverse (this._move.color ()));
		}
	 ...
	 */
		public int value (int player)
		{
			...
			} else if (Board.isWinner (this._board, aXon.TicTacToe.Game.TicTacToe.reverse (player))) {
				return int.MinValue;
			} else {
				return 0;
			}
